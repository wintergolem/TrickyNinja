...
//Name: sword_collider.ma
//Last modified: Fri, Feb 28, 2014 11:56:16 AM
//Codeset: 1252
requires maya "2014";
...
createNode mesh -n "sword_colliderShape" -p "sword_collider";
	...
	setAttr -s 16 ".pt";
	setAttr ".pt[8]" -type "float3" 0 -0.22817916 0 ;
	setAttr ".pt[9]" -type "float3" 0 -0.22817916 0 ;
	setAttr ".pt[10]" -type "float3" 0 -0.22817916 0 ;
	setAttr ".pt[11]" -type "float3" 0 -0.22817916 0 ;
	setAttr ".pt[14]" -type "float3" 0 -0.050850481 0 ;
	setAttr ".pt[15]" -type "float3" 0 -0.050850481 0 ;
	setAttr ".pt[18]" -type "float3" 0 -0.12289951 0 ;
	setAttr ".pt[19]" -type "float3" 0 -0.12289951 0 ;
	setAttr ".pt[22]" -type "float3" 0 -0.1346247 0 ;
	setAttr ".pt[23]" -type "float3" 0 -0.1346247 0 ;
	setAttr ".pt[26]" -type "float3" 0 -0.13504371 0 ;
	setAttr ".pt[27]" -type "float3" 0 -0.13504371 0 ;
	setAttr ".pt[28]" -type "float3" 0 0.055566326 0 ;
	setAttr ".pt[29]" -type "float3" 0 0.055566326 0 ;
	setAttr ".pt[30]" -type "float3" 0 -0.040405303 0 ;
	setAttr ".pt[31]" -type "float3" 0 -0.040405303 0 ;
...
select -ne :ikSystem;
	setAttr -s 4 ".sol";
connectAttr "sword_colliderShape.iog" ":initialShadingGroup.dsm" -na;
// End of sword_collider.ma
