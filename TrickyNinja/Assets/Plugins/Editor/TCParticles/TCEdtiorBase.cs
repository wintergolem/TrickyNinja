...
public class TCEdtiorBase<T> : Editor where T : Component
{
	...
	public void PropField(string varName, params GUILayoutOption[] options) {
	...
	public void PropField(string varName, string dispName, params GUILayoutOption[] options) {
		EditorGUILayout.PropertyField(CheckProp(varName), new GUIContent(dispName), options);
	}
	...
	public OpenClose GetOpenClose() {
		var o = AssetDatabase.LoadMainAssetAtPath("Assets/Plugins/Editor/TCParticles/OpenClose.asset") as OpenClose;

		if (o == null) {
			o = CreateInstance<OpenClose>();
			AssetDatabase.CreateAsset(o, "Assets/Plugins/Editor/TCParticles/OpenClose.asset");
		}
