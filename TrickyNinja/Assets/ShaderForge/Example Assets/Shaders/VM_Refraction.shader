...
/*SF_DATA;ver:0.34;sub:START;pass:START;ps:flbk:,lico:1,lgpr:1,nrmq:0,limd:1,uamb:False,mssp:True,lmpd:False,lprd:False,enco:False,frtr:True,vitr:True,dbil:False,rmgx:True,rpth:0,hqsc:True,hqlp:False,blpr:1,bsrc:3,bdst:7,culm:2,dpts:2,wrdp:True,ufog:False,aust:False,igpj:False,qofs:0,qpre:3,rntp:2,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,ofsf:0,ofsu:0,f2p0:False;n:type:ShaderForge.SFN_Final,id:0,x:33338,y:32442|diff-271-OUT,spec-75-OUT,gloss-76-OUT,normal-215-OUT,transm-29-OUT,lwrap-29-OUT,alpha-22-OUT,refract-14-OUT;n:type:ShaderForge.SFN_Slider,id:13,x:34032,y:33031,ptlb:Refraction Intensity,ptin:_RefractionIntensity,min:0,cur:0.1,max:1;n:type:ShaderForge.SFN_Multiply,id:14,x:33677,y:32724|A-309-OUT,B-220-OUT;n:type:ShaderForge.SFN_ComponentMask,id:16,x:33924,y:32557,cc1:0,cc2:1,cc3:-1,cc4:-1|IN-321-OUT;n:type:ShaderForge.SFN_Vector1,id:22,x:33677,y:32651,v1:0.3;n:type:ShaderForge.SFN_Tex2d,id:25,x:34163,y:32573,ptlb:Refraction,ptin:_Refraction,tex:64918bd998b46594e92b3b152c288075,ntxv:2,isnm:False|UVIN-222-UVOUT;n:type:ShaderForge.SFN_TexCoord,id:26,x:34848,y:32472,uv:0;n:type:ShaderForge.SFN_Multiply,id:27,x:34514,y:32566|A-26-UVOUT,B-28-OUT;n:type:ShaderForge.SFN_Vector1,id:28,x:34680,y:32677,v1:1;n:type:ShaderForge.SFN_Vector1,id:29,x:33677,y:32577,v1:1;n:type:ShaderForge.SFN_Vector1,id:75,x:34151,y:32257,v1:6;n:type:ShaderForge.SFN_Vector1,id:76,x:33677,y:32486,v1:0;n:type:ShaderForge.SFN_Lerp,id:215,x:33924,y:32408|A-216-OUT,B-321-OUT,T-13-OUT;n:type:ShaderForge.SFN_Vector3,id:216,x:34085,y:32445,v1:0,v2:0,v3:1;n:type:ShaderForge.SFN_Fresnel,id:217,x:33847,y:32284;n:type:ShaderForge.SFN_ConstantLerp,id:219,x:33677,y:32284,a:0.02,b:0.2|IN-217-OUT;n:type:ShaderForge.SFN_Multiply,id:220,x:33847,y:32803|A-13-OUT,B-221-OUT;n:type:ShaderForge.SFN_Vector1,id:221,x:34085,y:32831,v1:0.2;n:type:ShaderForge.SFN_Panner,id:222,x:34322,y:32485,spu:0,spv:0.75|UVIN-27-OUT;n:type:ShaderForge.SFN_Color,id:241,x:33741,y:32075,ptlb:WaterColor,ptin:_WaterColor,glob:False,c1:0.03445306,c2:0.01362458,c3:0.6176471,c4:1;n:type:ShaderForge.SFN_Blend,id:271,x:33362,y:32095,blmd:6,clmp:True|SRC-241-RGB,DST-219-OUT;n:type:ShaderForge.SFN_Multiply,id:309,x:33842,y:32699|A-16-OUT,B-25-A;n:type:ShaderForge.SFN_Lerp,id:321,x:34242,y:32755|A-25-RGB,B-327-RGB,T-381-G;n:type:ShaderForge.SFN_Tex2d,id:327,x:34484,y:32831,ptlb:node_327,ptin:_node_327,tex:5d5b7e333bb427b41829295a77add215,ntxv:2,isnm:False|UVIN-338-UVOUT;n:type:ShaderForge.SFN_Panner,id:338,x:34749,y:32859,spu:0,spv:0.5|UVIN-359-UVOUT;n:type:ShaderForge.SFN_TexCoord,id:359,x:35025,y:32822,uv:0;n:type:ShaderForge.SFN_VertexColor,id:381,x:34576,y:33032;proporder:13-25-241-327;pass:END;sub:END;*/

Shader "VMWater/VM_Refraction" {
    Properties {
...
/////// Normals:
                float4 node_2362 = _Time + _TimeEditor;
                float2 node_222 = ((i.uv0.rg*1.0)+node_2362.g*float2(0,0.75));
                float4 node_25 = tex2D(_Refraction,TRANSFORM_TEX(node_222, _Refraction));
                float2 node_338 = (i.uv0.rg+node_2362.g*float2(0,0.5));
                float3 node_321 = lerp(node_25.rgb,tex2D(_node_327,TRANSFORM_TEX(node_338, _node_327)).rgb,i.vertexColor.g);
                float3 normalLocal = lerp(float3(0,0,1),node_321,_RefractionIntensity);
                ...
                float2 sceneUVs = float2(1,grabSign)*i.screenPos.xy*0.5+0.5 + ((node_321.rg*node_25.a)*(_RefractionIntensity*0.2));
...
/////// Normals:
                ...
                float2 node_222 = ((i.uv0.rg*1.0)+node_2363.g*float2(0,0.75));
                float4 node_25 = tex2D(_Refraction,TRANSFORM_TEX(node_222, _Refraction));
                float2 node_338 = (i.uv0.rg+node_2363.g*float2(0,0.5));
                float3 node_321 = lerp(node_25.rgb,tex2D(_node_327,TRANSFORM_TEX(node_338, _node_327)).rgb,i.vertexColor.g);
                float3 normalLocal = lerp(float3(0,0,1),node_321,_RefractionIntensity);
                float3 normalDirection =  normalize(mul( normalLocal, tangentTransform )); // Perturbed normals
